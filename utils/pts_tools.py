...
# DATA_DIR = "/home/chujie/dataset/face_landmark/helen/trainset"
DATA_DIR = "/home/chujie/dataset/face_landmark/300VW_Dataset_2015_12_14/002/annot"
video = 1
...
def get_valid_box(image, points):
    ...
    _, raw_boxes = fd.get_facebox(image, threshold=0.9)
...
def preview(point_file):
    ...
    if video == 1:
        img_jpg = os.path.join(head + "/../image", image_file + ".jpg")
        img_png = os.path.join(head + "/../image", image_file + ".png")
    else:
